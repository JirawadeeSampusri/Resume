    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_study', models.DateTimeField(default=datetime.datetime(2021, 1, 16, 15, 36, 2, 774327, tzinfo=utc), verbose_name='Start Date')),
                ('end_study', models.DateTimeField(default=datetime.datetime(2021, 1, 16, 15, 36, 2, 774369, tzinfo=utc), verbose_name='End Date')),
            ],
        ),
        migrations.CreateModel(
            name='Info',
